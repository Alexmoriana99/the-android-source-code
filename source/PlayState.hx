...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			{
				defaultCamZoom = 0.85;
				curStage = 'yellow3Dsky';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('yellow3Dsky'));
							...
							case 'spaceSky':
			{
				defaultCamZoom = 0.85;
				curStage = 'spaceSky';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('spaceSky'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.6, 0.6);
				bg.active = true;
			...
			{
				defaultCamZoom = 0.85;
				curStage = 'orange3Dsky';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('orange3Dsky'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.6, 0.6);
				bg.active = true;
						...
						case 'godSky':
			{
				defaultCamZoom = 0.85;
				curStage = 'godSky';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('godSky'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.6, 0.6);
				bg.active = true;
				...
				case 'unfairSky':
			{
				defaultCamZoom = 0.85;
				curStage = 'unfairSky';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('unfairSky'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.6, 0.6);
				bg.active = true;
